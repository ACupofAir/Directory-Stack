#
# Module manifest for module 'dirStack'
#
...
FunctionsToExport = @("Get-Dir-Stack", "Set-Dir-Stack", "Remove-Dir-Stack-Item")
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/ACupofAir/Directory-Stack'
